  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass text-white rounded-2xl p-8 w-[340px] sm:w-[400px] max-w-full mx-4 text-center shadow-2xl"
      >
        ...
        <motion.div
          ...
          className="flex items-center justify-center space-x-3 text-lg font-medium text-white mb-4"
        >
        ...
        {showQuote && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="text-sm text-white/80 italic border-t border-t-green-600 pt-4"
          >
            {
              MOTIVATIONAL_QUOTES[
